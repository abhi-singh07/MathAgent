...
class UserProxyAgent:
    ...
    def check_queries(self, response: str):
        ...
        if len(queries) == 0:
            ...
            if len(queries) == 0:
                if (
                    ...
                    return (
                        "\nYour query is invalid and cannot be parsed. (If you already get the answer, put it in \\boxed{}. (Ensure there are two backward slashes before boxed{}).)",
                        True,
                    )
                else:
                    return "", False
        ...
        return (
            "\nAbove is the result to the queries. If you get to the final answer, put it in \\boxed{}. (Ensure there are two backward slashes before boxed{})",
            True,
        )
        ...
        if len(queries) == 0:
            ...
            if len(queries) == 0:
                if (
                    ...
                    return (
                        "Continue. Please keep solving the problem until you need to query. (If you get to the answer, put it in \\boxed{}. (Ensure there are two backward slashes before boxed{}).)",
                        True,
                    )
